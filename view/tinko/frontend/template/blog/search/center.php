 ...
 * файл view/example/frontend/template/blog/search/center.php,
 ...
 * $posts - результаты поиска (массив постов блога)
...
<!-- Начало шаблона view/example/frontend/template/blog/search/center.php -->
...
<?php if (empty($posts)): /* когда по запросу ничего не найдено */ ?>
...
<!-- Конец шаблона view/example/frontend/template/blog/search/center.php -->
